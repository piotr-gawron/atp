-- certificate db
CREATE TABLE atp_certificate (id int(6) NOT NULL auto_increment, certificate_number varchar(255) NOT NULL, building_number varchar(255), vin varchar(255), expire_date datetime not null, symbol varchar(255) not null, PRIMARY KEY (id),UNIQUE id (id));
-- user db
